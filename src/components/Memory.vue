    ...
    <div class="text-center">
        <div class="bg-600 text-0 rounded h-44 text-xl relative">
            ...
            <input
                ...
                v-if="toggle"
                v-model="scroll.seconds"
                @input="
						numPartsPerHour();
						profitIfKeepPerScroll();
						profitIfSellPerScroll();
					"
        ...
        >
            ...
            <div class="bg-600 text-0 rounded h-56 text-xl relative">
                ...
                <input
                    ...
                    @input="
							profitIfKeepPerScroll(scroll.seconds);
							profitIfSellPerScroll(scroll.seconds);
						"
                    class="text-center rounded bg-700 text-0 my-2 p-1 focus:outline-none"
                />
            </div>
